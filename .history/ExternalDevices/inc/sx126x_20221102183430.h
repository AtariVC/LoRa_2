...
typedef enum SX126x_IRQ_Status{
    SX126x_IRQ_TxDone,
    SX126x_IRQ_RxDone,
    SX126x_IRQ_PreambleDetected,
    SX126x_IRQ_SyncWordValid,
    SX126x_IRQ_HeaderValid,
    SX126x_IRQ_HeaderErr,
    SX126x_IRQ_CRC_Err,
    SX126x_IRQ_CadDone,
    SX126x_IRQ_CadDetected,
    SX126x_IRQ_Timeout
} SX126x_IRQ_Status;
...
uint16_t SX126x_GetIrqStatus(SX126x *driver);
