...
void System_Init(){
    ...
    ADC_Init(&adc);
    ADC_InitRegChannel(&adc, CH14, PC5, SMP_12);
    ADC_InitRegChannel(&adc, CH3, PC3, SMP_12);
    ADC_InitRegChannel(&adc, VREF, uninitialized, SMP_12);
    ADC_InitRegChannel(&adc, CH10, PA5, SMP_12);
    ADC_Enable(&adc);
