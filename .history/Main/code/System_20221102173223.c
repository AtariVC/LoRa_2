...
void System_Init(){
    ...
    Delay(500);
    uint16_t irq_status = SX126x_GetIrqStatus(&SX1268);
    SX126x_GetStatus(&SX1268);
    SX126x_GetStatus(&SX1268);
    SX126x_SetStandby(&SX1268, 0);
    SX126x_GetStatus(&SX1268);
    SX126x_SetRx(&SX1268, 0);
    SX126x_GetStatus(&SX1268);
    uint8_t pin_state = 0;
    pin_state = gpio_read(SX1268.gpio.DIO1_pin);
    SX126x_ReadBuffer(&SX1268, 128, buffer, 30);
    SX126x_GetStatus(&SX1268);
    SX126x_GetPacketStatus(&SX1268);
    SX126x_GetRxBufferStatus(&SX1268);
    irq_status = SX126x_GetIrqStatus(&SX1268);
    sim7000g = (GSM){
        .gpio = {
            .rx = UART3_RX,
            .tx = UART3_TX,
