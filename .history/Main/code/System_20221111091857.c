...
uint64_t reverse_bytes(uint64_t num){
    return (((num & 0xFF00000000000000) >> 56) | ((num & 0x00FF000000000000) >> 48) | ((num & 0x0000FF0000000000) >> 40) | ((num & 0x000000FF00000000) >> 32) | ((num & 0x00000000FF000000) >> 24) | ((num & 0x0000000000FF0000) >> 8) | ((num & 0x000000000000FF00) << 8) | ((num & 0x00000000000000FF) << 24) );
}
void System_Init(){
