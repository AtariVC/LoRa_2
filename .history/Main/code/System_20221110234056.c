...
void System_Init(){
    ...
    if(SX1268.self_addr != 1){
        ...
        uint8_t measured_data[53] = {0};
        measured_data[0] = 0x55;
        measured_data[1] = SX1268.self_addr;
        measured_data[2] = 1;
        measured_data[3] = MY_PERIODIC_DATA;
        ...
        gpio_state(TEMP_SENSOR_PWR_EN, LOW);
        gpio_state(SOIL_SENSOR_PWR_EN, LOW);
        SX126x_SendData(&SX1268, (uint8_t*)(&measured_data), 26);
