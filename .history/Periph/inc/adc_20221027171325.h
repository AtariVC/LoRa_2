...
typedef struct ADC{
    ...
    uint16_t vrefinternal_cal;  // = *(uint16_t*)0x1FFF75AA
    uint8_t last_conv_reg_ch;  // текущий номер регулярного канала, данные которого лежат в регистре (нужен для обработчика прерываний)
